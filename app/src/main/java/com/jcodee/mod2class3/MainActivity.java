...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Obtenemos el diseño de la parte superior del menu
        View view = navigationView.getHeaderView(0);

        TextView tvUsuario = (TextView) view.findViewById(R.id.tvUsuario);
        TextView tvNombreCompleto = (TextView) view.findViewById(R.id.tvNombreCompleto);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_agregar_cliente) {
            ...
            //Eliminamos la sesión del sharedPreference
